...
![EC2_instance_type](docs/images/EC2_instance_type.jpg)

6. Select a Key pair. If you didn't have one, click "Create new key pair".<br>
![EC2_instance_keypair](docs/images/EC2_instance_keypair.jpg)
...
![EC2_instance_storage](docs/images/EC2_instance_storage.jpg)

8. Launch the instance. You should see a message as shown below. Then, click "Connect to instance".<br>
![EC2_instance_success](docs/images/EC2_instance_success.jpg)

9. Click "Connect" at the bottom right corner.<br>
![EC2_instance_connect](docs/images/EC2_instance_connect.jpg)
...
![EC2_instance_install](docs/images/EC2_instance_install.jpg)
...
![EC2_instance_createimage](docs/images/EC2_instance_createimage.jpg)

2. Go through the process and you should see a message as shown below.<br>
![AMI_creating](docs/images/AMI_creating.jpg)
...
![Infrastructure_composer](docs/images/Infrastructure_composer.jpg)

2. Locate the FmriprepLambda component, and click "Details".<br>
![Lambda_change](docs/images/Lambda_change.jpg)
...
![python_runtime](docs/images/python_runtime.jpg)
![Lambda_environmental_variable](docs/images/Lambda_environmental_variable.jpg)
...
![Docker_function](docs/images/Docker_function.jpg)
...
4. A Zen dog picture for the road.<br> <p align="center"><img src="docs/images/Peaceful_dog.jpeg" width="300"></p>
