...
1. [Create an EC2 instance](https://github.com/jwu103/FMRIPREP-AWS/main/README.md#create-an-ec2-instance)
2. [Create an Amazon Machine Image from the EC2 instance](https://github.com/jwu103/FMRIPREP-AWS/main/README.md#create-an-amazon-machine-image-from-the-ec2-instance)
3. [Update the CloudFormation setting](https://github.com/jwu103/FMRIPREP-AWS/main/README.md#update-the-cloudformation-setting)
4. [Clean up and voilà](https://github.com/jwu103/FMRIPREP-AWS/main/README.md#clean-up-and-voil%C3%A0)
